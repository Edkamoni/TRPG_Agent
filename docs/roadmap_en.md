...
[English](./roadmap_en.md) | [中文](./roadmap_zh.md)

---

> TRPG-Agent is currently maintained and iterated by an individual; therefore, this roadmap only represents the opinions of myself and the community players. There is no guarantee that versions will be released exactly on schedule.
